...
- Use SwiftUI-native scenes and views first. If you need low-level window, responder-chain, text system, or panel control, switch to `macos-appkit-interop`.
...
- when to fall back to `macos-appkit-interop`
