...
- When the problem is fundamentally a missing desktop pattern, use `macos-swiftui-patterns`.
- When the problem is fundamentally a boundary with AppKit, use `macos-appkit-interop`.
